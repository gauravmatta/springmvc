...
//		System.out.println(student);
		...
		Student gaurav=(Student) context.getBean("student",Student.class);
		System.out.println(gaurav);
		Student mohit=(Student) context.getBean("raghavi",Student.class);
		System.out.println(mohit);
		
		//Using Constructors Injection
//		Employee gautam=new Employee(1,"Gautam");
//		System.out.println(gautam);
		Employee gautam=(Employee) context.getBean("employee",Employee.class);
		System.out.println(gautam);
		Employee billy=(Employee) context.getBean("billy",Employee.class);
